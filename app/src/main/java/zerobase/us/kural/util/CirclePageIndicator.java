...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.ViewPagerCirclePageIndicatorStyle);
    }
    ...
    public void setOrientation(int orientation) {
        switch (orientation) {
            ...
            default:
                throw new IllegalArgumentException(String.valueOf(R.string.orientation_illegal_argument_exception));
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int iLoop = 0; iLoop < count; iLoop++) {
            ...
            if (mPaintPageFill.getAlpha() > 0) {
                canvas.drawCircle(drawX, drawY, pageFillRadius, mPaintPageFill);
            }

            // Only paint stroke if a stroke width was non-zero
            if (pageFillRadius != mRadius) {
                canvas.drawCircle(drawX, drawY, mRadius, mPaintStroke);
            }
        }
        ...
        canvas.drawCircle(drawX, drawY, mRadius, mPaintFill);
    }
    ...
    public void setViewPager(ViewPager view) {
        ...
        if (view.getAdapter() == null) {
            throw new IllegalStateException(String.valueOf(R.string.adapter_illegal_argument_exception));
        }
        mViewPager = view;
    ...
    public void setCurrentItem(int item) {
        if (mViewPager == null) {
            throw new IllegalStateException(String.valueOf(R.string.viewpager_not_bound_illegal_argument_exception));
        }
